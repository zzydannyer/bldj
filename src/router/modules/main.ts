  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: '企业文化',
          icon: 'culture_enterprise'
        },
        children: [
          {
            name: 'Carrier',
            path: 'carrier',
            component: 'culture/enterprise/carrier/index',
            meta: {
              title: '文化载体',
              icon: '#'
            }
          },
          {
            name: 'CompanyInfo',
            path: 'CompanyInfo',
            component: 'culture/enterprise/carrier/CompanyInfo',
            meta: {
              title: '企业信息管理',
              icon: '#'
            }
          },
          {
            name: 'CultureInfo',
            path: 'cultureInfo',
            component: 'culture/enterprise/carrier/cultureInfo',
            meta: {
              title: '文化信息管理',
              icon: '#'
            }
          },
          {
            ...
            component: 'culture/enterprise/carrier/carrierDetail',
            meta: {
              title: '文化载体详情',
              icon: '#'
            }
          ...
          },
          {
            name: 'CultureYear',
            path: 'cultureYear',
            component: 'culture/enterprise/cultureYear/index',
            meta: {
              title: '集团文化年',
              icon: '#'
            }
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            name: 'Civilization',
            path: 'civilization',
            component: 'culture/civilization/civilization/index',
            meta: {
              title: '申创文明单位',
              icon: '#'
            }
          ...
          {
            name: 'CivilizationAudit',
            path: 'civilizationAudit',
            component: 'culture/civilization/civilizationAudit/index',
            meta: {
              title: '审核文明单位',
              icon: '#'
            }
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            name: 'DjHelp',
            path: 'djHelp',
            component: 'culture/society/djHelp/index',
            meta: {
              title: '党建帮扶',
              icon: '#'
            }
          },
          {
            name: 'DjHelpGroup',
            path: 'djHelpGroup',
            component: 'culture/society/djHelp/indexGroup',
            meta: {
              title: '党建帮扶统计',
              icon: '#'
            }
          ...
          {
            name: 'SocietyConsumeHelp',
            path: 'SocietyConsumeHelp',
            component: 'culture/society/consumeHelp/index',
            meta: {
              title: '消费帮扶',
              icon: '#'
            }
          ...
          {
            name: 'SocietyConsumeHelpGroup',
            path: 'SocietyConsumeHelpGroup',
            component: 'culture/society/consumeHelp/indexGroup',
            meta: {
              title: '消费帮扶统计',
              icon: '#'
            }
        ...
        children: [
          {
            name: 'MediaCheck',
            path: 'mediaCheck',
            component: 'media/mediaMain/check.vue',
            meta: {
              title: '资料审核',
              icon: '#'
            }
          },
          {
            name: 'MediaMain',
            path: 'mediaMain',
            component: 'media/mediaMain/index.vue',
            meta: {
              title: '资料上传',
              icon: '#'
            }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            name: 'SystemNews',
            path: 'systemNews',
            component: 'publicManage/homeMan/index',
            query: '{"homePlate": "home_system"}',
            meta: {
              title: '制度发布',
              icon: '#'
            }
        ...
        children: [
          {
            name: 'Manage',
            path: 'manage',
            component: 'politics/workDaily/manage/index',
            meta: {
              title: '任务督办',
              icon: '#'
            }
          },
          {
            name: 'Jc',
            path: 'jc',
            component: 'politics/workDaily/jc/jcList',
            meta: {
              title: '任务反馈',
              icon: '#'
            }
      ...
      },
      {
        ...
        children: [
          {
            name: 'MessagePushSetting',
            path: 'messagePushSetting',
            component: 'publicManage/messagePushSetting/index',
            meta: {
              title: '消息推送设置',
              icon: '#'
            }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'OrgBasic',
        path: 'orgBasic',
        component: 'manage/orgBasic/index',
        meta: {
          title: '行政机构',
          icon: 'tree'
        }
      },
      {
        name: 'Channel',
        path: 'channel',
        component: 'manage/channel/channelList',
        meta: {
          title: '栏目管理',
          icon: 'list'
        }
      ...
      },
      {
        name: 'CommonBut',
        path: 'commonBut',
        component: 'manage/commonButton/index',
        meta: {
          title: '常用按钮',
          icon: 'build'
        }
      ...
      },
      {
        name: 'OrgTreeConfig',
        path: 'OrgTreeConfig',
        component: 'system/orgTreeConfig/index',
        meta: {
          title: '组织树配置',
          icon: '#'
        }
