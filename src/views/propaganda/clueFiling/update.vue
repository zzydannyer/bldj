  ...
  <section class="container">
    <van-form input-align="left" @submit="onSubmit">
      <van-cell-group inset>
        ...
        <v-date-picker required v-model="form.startTime" :min-date="_5_years_ago"
                       label="开始时间" :rules="[{ required: true, message: '请选择开始时间' }]" placeholder="请选择开始时间" />
        <v-date-picker required v-model="form.endTime" :min-date="_5_years_ago"
                       label="结束时间" :rules="[{ required: true, message: '请选择结束时间' }]" placeholder="请选择结束时间" />
